...
import com.xgpush.cloud.ClickAction;
import com.xgpush.cloud.Style;
import com.xgpush.cloud.TimeInterval;
import com.xgpush.cloud.XingeApp;
...
//		}
    ...
    private void step7() {
        ...
        int ret_code = 0;
        try {
            com.xgpush.cloud.Message message = new com.xgpush.cloud.Message();
            message.setType(com.xgpush.cloud.Message.TYPE_NOTIFICATION);
